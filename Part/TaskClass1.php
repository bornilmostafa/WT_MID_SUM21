<?php
	...
	else if(strlen($_POST["name"]=="%")or strlen( $_POST["name"])=="+" or strlen($_POST["name"])=="{" or strlen( $_POST["name"])=="!" or strlen( $_POST["name"])== "-")
	 {
     $hasError=true;
		 $err_name="Name Undefined";
	 }
		else{
			$name = $_POST["name"];
		}
...
elseif(strlen($_POST["password"]) <= 5) {
	$hasError = true;
	$err_password="password must contain >5 character";
}
else{
