...
<html>
    ...
    <tr>
    <td>Address</td>
    <td>: <input type="text" name="address"value="<?php echo $address;?>" placeholder="Address...."> <br> <br><input type="text" name="city"value="<?php echo $city;?>" placeholder="City....">
      -<input type="text" name="state" value="<?php echo $state;?>" placeholder="State...."> <br>
      <br><input type="text" name="PZcode"value="<?php echo $PZcode;?>" placeholder="Postral/Zip Code....">
    </td>
